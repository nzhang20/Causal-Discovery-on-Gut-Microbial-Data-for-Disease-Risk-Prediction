...
def main_alg(frame,method:str='sparcc',
             ...
             norm:str='dirichlet',
             log:bool=True,
			 path_subdir_cor:str='./SparCC',
             path_subdir_cov:str='./SparCC',
             verbose:bool=True):
    '''
    ...
    if method in ['sparcc', 'clr']:
        ...
        filenames_cor=sorted([f for f in glob('SparCC/data' + "**/corr_files/*", recursive=True)])
        filenames_cov=sorted([f for f in glob('SparCC/data' + "**/cov_files/*", recursive=True)])
